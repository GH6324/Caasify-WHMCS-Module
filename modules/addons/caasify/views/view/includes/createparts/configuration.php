        ...
        <div v-if="planIsSelected" class="m-0 p-0">
                ...
                <div class="d-block d-lg-none m-0 p-0">
                    <div class="col-12 mt-3 mb-3" style="width: 120px !important;">
                        <span class="d-flex flex-row justify-content-start align-items-center">
                            <img src="<?php echo($PersonalRootDirectoryURL); ?>/modules/addons/caasify/views/view/includes/assets/img/ramicon.svg" alt="Memory">
                ...
                <div class="d-flex flex-row justify-content-between align-items-center m-0 p-0 pt-0 pt-md-4">
                    <div class=" d-none d-lg-block">
                        <span class="d-flex flex-row justify-content-start align-items-center" style="width: 120px !important;">
                            <img class="text-secondary p-0 m-0 pe-3" src="<?php echo($PersonalRootDirectoryURL); ?>/modules/addons/caasify/views/view/includes/assets/img/ramicon.svg" alt="Memory">
            ...
            <div class="row">
                ...
                <div class="d-block d-lg-none m-0 p-0">
                    <div class="col-12 mt-3 mb-3" style="width: 120px !important;">
                        <span class="d-flex flex-row justify-content-start align-items-center">
                            <img src="<?php echo($PersonalRootDirectoryURL); ?>/modules/addons/caasify/views/view/includes/assets/img/cpuicon.svg" alt="CpuCore">
                            <span class="p-0 m-0 h6 ms-2 me-2">
                                {{ lang('cpu') }}
                            </span>
                        </span>
                ...
                <div class="d-flex flex-row justify-content-between align-items-center m-0 p-0 pt-0 pt-md-5">
                    <div class=" d-none d-lg-block">
                        <span class="d-flex flex-row justify-content-start align-items-center" style="width: 120px !important;">
                            <img class="text-secondary p-0 m-0 pe-3" src="<?php echo($PersonalRootDirectoryURL); ?>/modules/addons/caasify/views/view/includes/assets/img/cpuicon.svg" alt="CpuCore">
                            <span class="p-0 m-0 me-2 h6">
                                {{ lang('cpu') }}
                            </span>
                        </span>
